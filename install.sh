...
cat > "$CONFIG_FILE" <<EOF
# Generated by install.sh — per-user runtime config for claude-vault-capture.
# Sourced by hooks/session-end-capture.sh. Gitignored; safe to edit.
CAPTURE_VAULT_DIR="$VAULT"
EOF
